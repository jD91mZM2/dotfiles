  ...
  home.services.polybar = {
    ...
    config = {
      ...
      "module/ewmh_taskbar" = {
        ...
        label-active-foreground = getColour 5;
        label-active-background = getColour 1;
        label-urgent-foreground = getColour 5;
      ...
      "module/pulseaudio" = {
        ...
        bar-volume-width = 10;
        bar-volume-empty = "█";
        bar-volume-empty-foreground = getColour 3;
        bar-volume-fill = "█";
